...
export default function Navbar() {
  const { isLoggedIn, setIsLoggedIn, trainee, setTrainee} = useContext(AuthContext);
              ...
              <li className="flex items-center gap-2 p-3 border-b border-gray-200">
                ...
                <div>
                  <h6 className="text-sm font-medium text-gray-700">
                    {trainee?.firstName || "User"}
                  </h6>
                  <small className="text-xs text-gray-500">Trainee</small>
                </div>
              </li>
              <li>
                <Link
                  href="/my-profile-trainees"
